...
namespace CodeMonkey.Utils {
  ...
  public class FunctionPeriodic {
    ...
    public static FunctionPeriodic Create(Action action, Func<bool> testDestroy, float timer, string functionName, bool useUnscaleDeltaTime, bool triggerImmediately, bool stopAllWithSameName) {
      InitIfNeeded();
